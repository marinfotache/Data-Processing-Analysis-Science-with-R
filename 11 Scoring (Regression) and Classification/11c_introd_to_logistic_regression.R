...
# this package is useful for assessing the model performance
library(performance)
...
# roc with package `performance`
performance::performance_roc(log_reg__heart, new_data = heart)
plot(performance::performance_roc(log_reg__heart, new_data = heart))
