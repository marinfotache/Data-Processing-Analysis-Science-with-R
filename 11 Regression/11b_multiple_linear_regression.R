...
###
#######################################################################
###     11b Multiple (Ordinary Least Square) Linear Regression      ###
### See also the presentation:
### https://github.com/marinfotache/Data-Processing-Analysis-Science-with-R/blob/master/11%20Regression/11_regression.pptx
#######################################################################
...
births2006_lm3 <- lm(BabyWeight ~ Gestation_Weeks + Mother_WeightGain_Kg +
